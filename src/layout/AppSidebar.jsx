  ...
  return (
    ...
    >
      <div className="flex flex-col h-full overflow-hidden">
        ...
        <div className="p-3 bg-gradient-to-r from-[#2C1D11] via-[#3d2612] to-[#8C6D23] text-white flex items-center justify-between shadow-xs border-b border-[#C9A84C]/30">
          <div className="flex items-center gap-2.5 overflow-hidden">
            ...
            {!isCollapsed && (
              <div className="min-w-0 flex-1">
                <h2 className="text-sm font-bold leading-tight truncate text-[#E5D7B7]">
                  {activeSystem.label}
                </h2>
              </div>
            )}
