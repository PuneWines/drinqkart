    ...
    <div className="bg-white rounded-2xl sm:rounded-3xl p-3.5 sm:p-5 shadow-sm border border-gray-100 flex flex-col gap-3 sm:gap-4 overflow-hidden h-full">
      ...
      <div className="relative">
        <input
          ...
          className="w-full pl-9 sm:pl-11 pr-3.5 py-2.5 sm:py-3 bg-[#f9fafb] border border-gray-200 rounded-xl sm:rounded-2xl text-xs sm:text-sm focus:outline-none focus:border-[#25D366] transition-colors font-medium placeholder-gray-400"
        />
        <Search className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-gray-400 absolute left-3 sm:left-4 top-1/2 -translate-y-1/2" />
      </div>
