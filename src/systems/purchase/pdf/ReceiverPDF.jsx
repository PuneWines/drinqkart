        ...
        <View style={styles.headerArea}>
          ...
          <View style={styles.detailsRow}>
            <View style={styles.detailsLeft}>
              ...
              <Text style={styles.copyType}>Duplicate for Receiver</Text>
            </View>
        ...
        <View style={styles.table}>
          ...
          {items.map((item, index) => {
            ...
            return (
              <View key={item.id || index} style={rowStyle}>
                ...
                <Text style={[styles.tableCell, styles.colQtyType, { color: "#64748b", fontSize: 7.5 }]}>
                  {item.qtyType || "—"}
                </Text>
              </View>
            );
          ...
          {items.length > 0 && (
            <View style={styles.tableTotalRow}>
              <Text style={[styles.tableTotalCell, { width: "65%", textAlign: "right" }]}>Total:</Text>
              ...
              <Text style={[styles.tableTotalCell, styles.colQtyType]}></Text>
            </View>
          )}
        </View>
