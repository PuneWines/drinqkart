...
export default function MasterSetting() {
  ...
  return (
    <div className="p-6 bg-[#FAFAFA] min-h-screen text-[#1A1A1A] font-sans">
      {/* Toast Notification */}
      {toastMessage && (
        <div
          ...
          <table className="w-full text-left border-collapse text-xs">
            <thead>
              <tr className="bg-[#1A1A1A] border-b border-[#1A1A1A] uppercase font-serif text-[#C9A84C] tracking-[0.15em] text-[10.5px]">
                ...
                <th className="py-4 px-4">Shop Access (shop_name)</th>
                ...
                filteredUsers.map((u) => {
                  ...
                  return (
                    <tr key={u.id} className="hover:bg-[#FAFAFA] transition-colors">
                      ...
                      {/* Column 4: Shop Access (shop_name) */}
                      <td className="py-3.5 px-4 font-medium text-[#1A1A1A]">
                        {u.shop_name ? (
                          <span className="px-2.5 py-1 bg-[#C9A84C]/15 border border-[#C9A84C]/40 rounded text-[10.5px] font-semibold font-mono text-[#1A1A1A]">
                            {u.shop_name}
                          </span>
                        ) : (
