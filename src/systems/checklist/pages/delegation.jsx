                ...
                <div className="hidden md:block overflow-auto max-h-[calc(100vh-280px)] custom-scrollbar">
                  <table className="min-w-full divide-y divide-gray-200 relative">
                    <thead className="bg-gray-50 sticky top-0 z-20 shadow-xs">
                      <tr>
                        <th className="px-3 py-2.5 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider whitespace-nowrap">
                          Task ID
                        </th>
                        <th className="px-3 py-2.5 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider whitespace-nowrap">
                          Level
                        </th>
                        <th className="px-3 py-2.5 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider min-w-[200px]">
                          Task
                        </th>
                        <th className="px-3 py-2.5 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider whitespace-nowrap">
                          Timestamp
                        ...
                        <th className="px-3 py-2.5 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider min-w-[150px]">
                          Remarks
                        </th>
                        <th className="px-3 py-2.5 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider whitespace-nowrap">
                          Image
                        ...
                        paginatedTasks.map((history, index) => (
                          <tr key={index} className="hover:bg-gray-50">
                            <td className="px-3 py-2.5">
                              <div className="text-xs text-gray-900 whitespace-normal break-words">
                                {history.id || "—"}
                              </div>
                            </td>
                            <td className="px-3 py-2.5">
                            ...
                            <td className="px-3 py-2.5 min-w-[200px] max-w-[300px]">
                            ...
                            <td className="px-3 py-2.5">
                              <div className="text-xs font-medium text-gray-900 whitespace-normal break-words">
                            ...
                            <td className="px-3 py-2.5 bg-purple-50 min-w-[150px] max-w-[250px]">
                              <div
                                className="text-xs text-gray-900 whitespace-normal break-words leading-relaxed"
                              ...
                              {history.image_url ? (
                                ...
                                >
                                  <img
                                    ...
                                    alt="Attachment"
                                    className="h-6 w-6 object-cover rounded-md mr-2 flex-shrink-0"
                                  />
              ...
              <>
                ...
                <div className="hidden md:block overflow-auto max-h-[calc(100vh-280px)] custom-scrollbar">
                  <table className="min-w-full divide-y divide-gray-200 relative">
                    <thead className="bg-gray-50 sticky top-0 z-20 shadow-xs">
                      <tr>
                        <th className="px-3 py-2.5 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider">
                          <input
                            type="checkbox"
                        ...
                        <th className="px-3 py-2.5 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider whitespace-nowrap bg-green-50">
                          Planned Date
                        </th>
                        <th className="px-3 py-2.5 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider whitespace-nowrap bg-blue-50">
                          Select Status
                        </th>
                        <th className="px-3 py-2.5 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider whitespace-nowrap bg-indigo-50">
                          Next Target
                        </th>
                        <th className="px-3 py-2.5 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider min-w-[150px] bg-purple-50">
                          Remarks
                        </th>
                        <th className="px-3 py-2.5 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider whitespace-nowrap bg-orange-50">
                          Upload
                        </th>
                      </tr>
                    </thead>
                          ...
                          return (
                            <Fragment key={index}>
                              ...
                              >
                                ...
                                <td className="px-3 py-2.5 bg-green-50">
                                  {task.task_start_date && formatDateTimeForDisplay(task.task_start_date) !== formatDateTimeForDisplay(task.planned_date) ? (
                                    ...
                                    <div className="text-xs text-gray-900 whitespace-normal break-words font-medium">
                                      {formatDateTimeForDisplay(task.planned_date)}
                                    </div>
                                  )}
                                </td>
                                <td className="px-3 py-2.5 bg-blue-50">
                                  <select
                                    disabled={!isSelected}
                                    ...
                                    className="border border-gray-300 rounded-md px-2 py-1 w-full disabled:bg-gray-100 disabled:cursor-not-allowed text-xs"
                                  >
                                ...
                                <td className="px-3 py-2.5 bg-indigo-50">
                                  <input
                                    type="date"
                                    disabled={
                                      !isSelected ||
                                ...
                                <td className="px-3 py-2.5 min-w-[150px] max-w-[250px] bg-purple-50">
                                  <textarea
                                    ...
                                    className="border border-gray-300 rounded-md px-2.5 py-1.5 w-full h-8 sm:h-auto min-h-[32px] sm:min-h-[48px] disabled:bg-gray-100 disabled:cursor-not-allowed text-xs resize-none"
                                  />
                                </td>
                                <td className="px-3 py-2.5 bg-orange-50">
