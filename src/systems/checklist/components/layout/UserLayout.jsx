...
const UserLayout = ({ children }) => {
  ...
  if (isEmbedded) {
    return (
      <div className="flex-1 h-screen overflow-y-auto bg-gradient-to-br from-green-50 to-teal-50 dark:from-gray-900 dark:to-teal-950 p-4 md:p-6 animate-fadeIn">
        {children}
      </div>
    );
  }
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gradient-to-br from-green-50 to-teal-50 dark:from-gray-900 dark:to-teal-950">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <div className="bg-[#C9A84C] h-5 flex items-center justify-center px-4 shadow-md z-40">
          <a
            href="https://www.botivate.in"
            target="_blank"
            rel="noopener noreferrer"
            className="text-[9px] text-[#1A1A1A] font-medium tracking-[0.2em] uppercase hover:underline transition-colors"
          >
