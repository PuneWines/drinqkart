                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 bg-slate-50 p-5 rounded-xl border border-slate-200">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full border border-slate-300 rounded-xl px-4 py-2.5 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all ${allowedTypes.length <= 1 ? 'bg-slate-100 text-slate-500 cursor-not-allowed' : 'bg-white cursor-pointer'
                        }`}
                    >
                      {isPurchaseAllowed && (
                          ...
                          >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                              ...
                              <div className="md:col-span-3">
                                ...
                                <label className="block text-[11px] font-bold text-slate-500 mb-1.5 uppercase w-240">Item Name</label>
                                <SearchableDropdown
                                  value={row.itemName}
